...
public class Assignment implements Comparable<Assignment> {
    ...
    public int compareTo(Assignment o) {
        Comparator<Assignment> comparator = Comparator
            .comparing(Assignment::getCategory)
    ...
    public boolean equals(Object obj) {
        ...
        return (this.getTitle() == ((Assignment) obj).getTitle())
            && (this.getCategory() == ((Assignment) obj).getCategory());
    }
