...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        list.add(new Professor("Bob", "Jones", 4, 5));
        list.add(new Student("Bill", "Billson", 10, 10));
        list.add(new UndergraduateStudent("Walter", "White", 10, 10));
        list.add(new GraduateStudent("John", "Appleseed", 5, 5));
