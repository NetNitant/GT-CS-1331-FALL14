...
/**
 * a tool that draws empty ovals
 * @author Nitant Dandekar
 * @version 1
 */
public class StrokeOvalTool implements Tool {
    private double startX;
    private double startY;
    private double endX;
    private double endY;
    private static final String TOOL_NAME = "StrokeOval";
    ...
    public void onRelease(MouseEvent e, GraphicsContext g) {
        ...
        g.strokeOval(topLeftX, topLeftY, bottomRightX - topLeftX
